...
#if defined O_OTEC
      integer nta_OTEC
      common /ta_OTEC_i/ nta_OTEC      

      real ta_numplt, ta_locrem, ta_grdavg, ta_totlev, ta_vendth
      real ta_poterg
      common /ta_OTEC_r/ ta_numplt(imt,jmt), ta_locrem(imt,jmt)
      common /ta_OTEC_r/ ta_grdavg(imt,jmt), ta_totlev(imt,jmt)
      common /ta_OTEC_r/ ta_vendth(imt,jmt), ta_poterg(imt,jmt)
#endif
